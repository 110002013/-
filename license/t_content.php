...
<?php
//接收judge.php中抓到的資料
	$in_time = isset($_GET["in_time"])?$_GET["in_time"]:"";
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
		  ...
		  <!--圖片來源:https://www.g-no7.com/?f=2&id=2973-->
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>入場時間:</strong> <span><?php echo $in_time;?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>出場時間:</strong> <span><?php echo $out_time;?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>位置:</strong> <span><?php echo $position;?></span></li>      
				 <li><i class="bi bi-chevron-right"></i> <strong>應繳金額:</strong> <span><?php echo $money;?></span></li>
                </ul>
              </div>
            </div>
          </div>
